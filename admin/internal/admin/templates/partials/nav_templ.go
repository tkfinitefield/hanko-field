		...
		for _, group := range resolveMenu(ctx, groups) {
			if items := visibleItems(group, ctx); len(items) > 0 {
				...
				if strings.TrimSpace(group.Label) != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/templates/partials/nav.templ`, Line: 51, Col: 45}
					}
				...
				for _, item := range items {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/templates/partials/nav.templ`, Line: 57, Col: 51}
					}
					...
					if strings.TrimSpace(item.Icon) != "" {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/templates/partials/nav.templ`, Line: 69, Col: 109}
						}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/templates/partials/nav.templ`, Line: 71, Col: 54}
					}
